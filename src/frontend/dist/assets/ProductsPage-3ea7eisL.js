import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, f as composeRefs, R as React2, g as useComposedRefs, h as reactDomExports, i as React, k as ReactDOM, a as cn, u as useNavigate, l as useSearch, X, B as Button, e as useCartStore, b as useSpeakWithNarration, L as Link, S as ShoppingCart, V as Volume2, s as showCartToast } from "./index-BoX3_azF.js";
...
import { P as PRODUCTS, C as CATEGORIES, S as Star } from "./products-CRBQERT2.js";
import { m as motion } from "./proxy-D9ePEMhA.js";
import { S as Search } from "./search-Cww8LSD3.js";
/**
...
function ProductCard({ product, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.article,
    {
      ...
      transition: { duration: 0.35, delay: index2 * 0.05, ease: "easeOut" },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-xl mb-4 bg-muted aspect-[4/3]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                ...
                product.featured && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "gradient-primary text-white border-0 text-xs font-semibold", children: "⭐ Featured" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs font-medium", children: product.category }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground leading-tight line-clamp-2 flex-1", children: product.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-bold text-primary flex-shrink-0", children: [
                    "$",
                    product.price
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: product.rating }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1 pt-1", children: [
                  product.accessibilityTags.slice(0, 3).map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "secondary",
                  ...
                  product.accessibilityTags.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Badge,
                    {
                      variant: "outline",
                      className: "text-xs rounded-full px-2 py-0.5",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-4 mt-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
...
function ProductsPage() {
  ...
  function updateSearch(updates) {
    ...
    const next = Object.fromEntries(
      Object.entries(merged).filter(
        ([k, v]) => v && !(k === "category" && v === "All") && !(k === "sort" && v === "price-asc")
      )
    );
  ...
  const filtered = reactExports.useMemo(() => {
    let result = PRODUCTS.filter((p) => {
      ...
      const matchQ = !q || p.name.toLowerCase().includes(q) || p.description.toLowerCase().includes(q) || p.accessibilityTags.some((t) => t.toLowerCase().includes(q));
  ...
  const productCountLabel = isFiltered ? `Showing ${filtered.length} of ${PRODUCTS.length} products` : `${PRODUCTS.length} products`;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedPage, { className: "flex-1 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mb-8",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-section mb-1 font-display", children: "All Products" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "search",
            value: query,
            onChange: (e) => updateSearch({ q: e.target.value || void 0 }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.entries(SORT_LABELS).map(
                ([value, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value, className: "text-sm", children: label }, value)
              ) })
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { className: "border-0 p-0 m-0 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: "sr-only", children: "Filter by category" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", "data-ocid": "category-filter", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Funnel,
          {
        ...
        ["All", ...CATEGORIES].map((cat) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              type: "button",
              onClick: () => updateSearch({ category: cat === "All" ? void 0 : cat }),
              className: `px-4 py-2 rounded-full text-sm font-semibold transition-smooth min-h-[44px] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 ${isActive ? "gradient-primary text-white shadow-subtle" : "bg-muted text-muted-foreground hover:bg-secondary hover:text-foreground"}`,
    ...
    filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-readable max-w-md", children: [
            "We couldn't find anything matching",
            " ",
            query ? /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
              '"',
              query,
              '"'
            ] }) : "your filters",
