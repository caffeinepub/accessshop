import { c as createLucideIcon, r as reactExports, u as useNavigate, b as useSpeakWithNarration, j as jsxRuntimeExports, B as Button, L as Link, S as ShoppingCart, A as Accessibility, d as AccessibilityPanel, e as useCartStore, V as Volume2, s as showCartToast } from "./index-BoX3_azF.js";
...
import { C as CATEGORIES, F as FEATURED_PRODUCTS, S as Star } from "./products-CRBQERT2.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Star,
              {
                className: `h-3.5 w-3.5 ${i < Math.floor(product.rating) ? "fill-yellow-400 text-yellow-400" : "fill-muted text-muted-foreground"}`
              },
              `star-${product.id}-${i}`
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground ml-0.5", children: product.rating }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4", children: CATEGORIES.map((cat, i) => {
